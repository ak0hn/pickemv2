...
// standings snapshot (top 5, for the announcement post). Delegates the actual computation
// to lib/results/compute.ts's computeWeekResults (PIC-24) — that function is the shared,
// non-mutating source of truth for results/standings; this just slices its full standings
// list down to a short snippet suitable for a post. See computeWeekResults for the ATS
